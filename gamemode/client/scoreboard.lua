...
local PLAYER_LINE = 
{
	Init = function( self )
		...
		self.Deaths:SetColor(color_text)
		...
		self.Kills:SetColor(color_text)
	...
	Paint = function( self, w, h )
		...
		draw.RoundedBox( 4, 1, 1, w-2, h-2, team.GetColor(self.Player:Team()))
